...
<div class="container d-flex flex-column">
    ...
    <div class="d-flex justify-content-sm-between m-lg-5">
        <a href="/purchase/generatePDF" class="btn fa fa-file-pdf-o m-lg-2 " style="font-size:50px;color:green;"></a>
        <a href="/purchase" class="btn fa fa-angle-left" style="font-size:48px;color:red"></a>
    </div>
